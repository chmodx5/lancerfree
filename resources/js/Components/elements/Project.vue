        ...
        <Link href="/worker/project/id">
            <div className="hover:cursor-pointer">
                ...
                <div className="text-sm">
                    ...
                    Corporis accusamus placeat nostrum ducimus mollitia
                    consequatur fugiat laboriosam veniam molestias dolore non,
                    excepturi natus, et numquam ut. Debitis optio minima
                    vero?......
                </div>
                <div className="py-2">
                    <ul>
                        <li><Chip item="something" /></li>
                    </ul>
                </div>
